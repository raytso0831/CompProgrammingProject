...
def winner():
    ...
    if check_row_for_winner() == 'player' or check_col_for_winner()=='player'or diagonal()=='player':
        Sprite(user_winner,(550,200))
        data['Game Over']=True
    elif check_row_for_winner() == 'computer'or check_col_for_winner() or diagonal()=='computer':
